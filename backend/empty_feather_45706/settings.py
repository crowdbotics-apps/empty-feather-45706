"""
Django settings for empty_feather_45706 project.
...
ROOT_URLCONF = 'empty_feather_45706.urls'
...
WSGI_APPLICATION = 'empty_feather_45706.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "empty_feather_45706 API",
    "DESCRIPTION": "API documentation for empty_feather_45706 App",
    "VERSION": "v1",
}
